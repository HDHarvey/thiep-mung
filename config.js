...
const eventName = 'Sinh nhật dui dẻ :33';
const titleCard = 'Tặng người ấy';
const contentCard = 'Chúc bạn sinh nhật tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với em trong hôm nay và cả những ngày sau';
