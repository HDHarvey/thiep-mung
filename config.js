...
const eventName = 'Sinh nhật dui dẻ';
const titleCard = 'Tặng người ấy';
const contentCard = 'Chúc bạn của tui sinh nhật tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với em trong hôm nay và cả những ngày sau';
